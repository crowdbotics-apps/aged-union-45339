"""
Django settings for aged_union_45339 project.
...
ROOT_URLCONF = 'aged_union_45339.urls'
...
WSGI_APPLICATION = 'aged_union_45339.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_union_45339 API",
    "DESCRIPTION": "API documentation for aged_union_45339 App",
    "VERSION": "v1",
}
